...
// const BotonPujar = ({producto,emailPujador}) => {
...
//           const response = await axios.post(`http://localhost:5000/api/v1/pujas/`, { "producto": producto._id,"cantidad": precio,"emailPujador": emailPujador });
